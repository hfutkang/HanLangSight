...
import com.ingenic.glass.camera.ui.FaceView;
import com.ingenic.glass.camera.ui.FocusIndicator;
import com.ingenic.glass.camera.ui.FocusIndicatorView;
...
public class FocusManager {
    ...
    public void initialize(View focusIndicatorRotate, View previewFrame,
            ...
            Log.e(TAG, "--initialize---in focusIndicatorRotate="+focusIndicatorRotate);
    ...
    public boolean autoFocusCapture() {
	Log.d(TAG,"autoFocusCapture in");
	mFocusMode = Parameters.FOCUS_MODE_AUTO;
        if (isSupported(Parameters.FOCUS_MODE_AUTO, mParameters.getSupportedFocusModes())) {
            ...
            onShutterDown();
            mInLongPress = false;
	    Log.d(TAG,"autoFocusCapture in11");
	    return true;
        }else{
	    Log.d(TAG,"autoFocusCapture in22");
	    return false;
	}
    }

    public void doSnap() {
	    Log.d(TAG,"doSnap in mState="+mState);
        if (!mInitialized) return;
	...
	Log.d(TAG,"onAutoFocus mState="+mState);
